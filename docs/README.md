...
|---|---|
| [`ARCHITECTURE.md`](ARCHITECTURE.md) | End-to-end design, stages 0–7, offline, deployment |
...
| [`AUDIT_AND_XAI.md`](AUDIT_AND_XAI.md) | Per-step explainability, validators, audit trail |
| [`sample_reports/`](sample_reports/) | Checked-in demo report snapshots (analytics + RAG + audit) |
...
Stage 7     Per-step audit / XAI      → AUDIT_AND_XAI.md, sample_reports/
```
